    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
                ...
                <p class="lead mb-4">Program les privat online khusus untuk siswa Sekolah Dasar dengan metode pembelajaran yang menyenangkan dan efektif.</p>
            ...
            <div class="col-lg-6">
                <img src="{{ asset('assets/svg/hero-image.svg') }}" alt="Les Privat SD" class="img-fluid">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex align-items-center">
                            <img src="{{ asset('assets/img/avatar-default.jpg') }}" alt="Parent" class="rounded-circle me-3" width="48" height="48">
                            <div>
