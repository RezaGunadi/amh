                ...
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex align-items-center">
                            <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Rina&backgroundColor=lightblue" alt="Student" class="rounded-circle me-3" width="48" height="48">
                            <div>
            ...
            <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex align-items-center">
                            <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Ahmad&backgroundColor=lightblue" alt="Student" class="rounded-circle me-3" width="48" height="48">
                            <div>
            ...
            <div class="col-lg-4" data-aos="fade-up" data-aos-delay="300">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex align-items-center">
                            <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Sari&backgroundColor=lightblue" alt="Student" class="rounded-circle me-3" width="48" height="48">
                            <div>
