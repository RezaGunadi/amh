    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <nav class="mb-8" aria-label="breadcrumb">
            <ol class="flex items-center space-x-2 text-sm text-gray-600">
                ...
                <li>
                    <a href="{{ route('blog') }}" class="hover:text-blue-600 transition-colors duration-200">Blog</a>
                </li>
                <li>
                    <svg class="w-4 h-4 text-gray-400" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"/>
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <header class="bg-white rounded-2xl shadow-lg p-8 mb-8">
                ...
                <div class="flex flex-wrap items-center gap-6 text-gray-600 mb-8">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-sm">{{ $post->published_at ? $post->published_at->format('d M Y') : $post->created_at->format('d M Y') }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <span class="font-medium">{{ $post->reading_time }} menit baca</span>
                    </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <span class="font-medium">{{ $post->views ?? rand(100, 500) }} kali dibaca</span>
                    </div>
                </div>
                ...
                @else
                <div class="relative mb-8">
                    <div class="w-full h-64 md:h-80 bg-gradient-to-br from-blue-400 to-purple-600 rounded-xl flex items-center justify-center">
            ...
            <article class="bg-white rounded-2xl shadow-lg p-8 mb-8">
                <div class="prose prose-lg max-w-none">
                    <div class="text-gray-700 leading-relaxed text-base space-y-6">
                        {!! $post->content !!}
                    </div>
                </div>
            </article>
                    ...
                    <div class="mb-6 md:mb-0">
                        ...
                        <div class="flex space-x-3">
                            ...
                            <a href="https://twitter.com/intent/tweet?url={{ urlencode(url('/blog/' . $post->slug)) }}&text={{ urlencode($post->title) }}" 
                               target="_blank" 
                               class="flex items-center justify-center w-10 h-10 bg-sky-500 text-white rounded-full hover:bg-sky-600 transition-colors duration-200">
                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="https://wa.me/?text={{ urlencode($post->title . ' - ' . url('/blog/' . $post->slug)) }}" 
                               target="_blank" 
                               class="flex items-center justify-center w-10 h-10 bg-green-500 text-white rounded-full hover:bg-green-600 transition-colors duration-200">
                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
